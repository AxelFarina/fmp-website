...
export const products = {
  'sap-business-one': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◇', title: 'Gestión financiera', desc: 'Automatiza procesos contables, controla flujos de caja, gestiona informes financieros y facilita el cumplimiento normativo.' },
        { icon: '⟐', title: 'Ventas y atención al cliente', desc: 'Mejora la gestión de ventas, desde la generación de oportunidades hasta la gestión de pedidos y el servicio postventa, fortaleciendo la relación con el cliente.' },
        { icon: '⬡', title: 'Compras y gestión de inventarios', desc: 'Optimiza el control de inventarios, gestiona las compras y facilita la planificación de la demanda para mantener los niveles adecuados de stock.' },
        { icon: '⚙', title: 'Operaciones y producción', desc: 'Coordina los procesos de producción, controla los costos y gestiona las operaciones de manufactura y logística.' },
        { icon: '◎', title: 'Informes y análisis', desc: 'Ofrece herramientas avanzadas de análisis y generación de informes para proporcionar información valiosa sobre el rendimiento del negocio.' },
        { icon: '✦', title: 'Interfaz intuitiva y accesibilidad', desc: 'Diseñado para ser fácil de usar, SAP Business One está disponible tanto en versiones on-premise como en la nube, adaptándose a las necesidades de su empresa.' },
      ],
      sections: [
        {
          type: 'modules', title: 'Módulos',
          items: [
            { icon: '▤', label: 'Existencias' }, { icon: '◈', label: 'Finanzas' }, { icon: '⇗', label: 'Ventas' },
            { icon: '▥', label: 'Reportes' }, { icon: '⇄', label: 'Compras' }, { icon: '⚙', label: 'Manufactura' },
          ],
        },
        {
    ...
    en: {
      ...
      highlights: [
        { icon: '◇', title: 'Financial management', desc: 'Automates accounting processes, controls cash flow, manages financial reporting, and simplifies regulatory compliance.' },
        { icon: '⟐', title: 'Sales and customer care', desc: 'Improves sales management from lead generation to order handling and after-sales service, strengthening customer relationships.' },
        { icon: '⬡', title: 'Purchasing and inventory', desc: 'Optimizes inventory control, manages purchasing, and supports demand planning to keep stock at the right levels.' },
        { icon: '⚙', title: 'Operations and production', desc: 'Coordinates production processes, controls costs, and manages manufacturing and logistics operations.' },
        { icon: '◎', title: 'Reporting and analytics', desc: 'Delivers advanced analysis and reporting tools that turn business performance into actionable insight.' },
        { icon: '✦', title: 'Intuitive interface, anywhere access', desc: 'Designed to be easy to use, SAP Business One is available both on-premise and in the cloud, adapting to your company’s needs.' },
      ],
      sections: [
        {
          type: 'modules', title: 'Modules',
          items: [
            { icon: '▤', label: 'Inventory' }, { icon: '◈', label: 'Finance' }, { icon: '⇗', label: 'Sales' },
            { icon: '▥', label: 'Reporting' }, { icon: '⇄', label: 'Purchasing' }, { icon: '⚙', label: 'Manufacturing' },
          ],
        },
        {
  ...
  'sap-s4hana-rise': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◉', title: 'Dirigido a', desc: 'Empresas medianas a grandes con requisitos complejos.' },
        { icon: '⟐', title: 'Personalización', desc: 'Altamente personalizable, con opciones de implementación Greenfield, Brownfield y Bluefield.' },
        { icon: '☁', title: 'Implementación', desc: 'Nube privada, con flexibilidad en entornos de alojamiento (AWS, Google Cloud, Azure).' },
        { icon: '◎', title: 'Soporte', desc: 'Modelo de soporte flexible y control sobre las actualizaciones.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '◉', title: 'Built for', desc: 'Medium to large companies with complex requirements.' },
        { icon: '⟐', title: 'Customization', desc: 'Highly customizable, with Greenfield, Brownfield, and Bluefield deployment options.' },
        { icon: '☁', title: 'Deployment', desc: 'Private cloud, with flexible hosting environments (AWS, Google Cloud, Azure).' },
        { icon: '◎', title: 'Support', desc: 'Flexible support model and control over updates.' },
      ],
      sections: [],
    },
  },
  ...
  'sap-s4hana-grow': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◉', title: 'Dirigido a', desc: 'Pequeñas y medianas empresas que buscan simplificación.' },
        { icon: '⟐', title: 'Personalización', desc: 'Limitada, enfocada en procesos estandarizados.' },
        { icon: '☁', title: 'Implementación', desc: 'Nube pública, preconfigurada para una rápida implementación.' },
        { icon: '◎', title: 'Soporte', desc: 'Actualizaciones regulares cada seis meses gestionadas por SAP.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '◉', title: 'Built for', desc: 'Small and midsize companies looking for simplification.' },
        { icon: '⟐', title: 'Customization', desc: 'Focused and standardized, built around best-practice processes.' },
        { icon: '☁', title: 'Deployment', desc: 'Public cloud, preconfigured for rapid implementation.' },
        { icon: '◎', title: 'Support', desc: 'Regular updates every six months, managed by SAP.' },
      ],
      sections: [],
    },
  },
  ...
  'trebol-hrm-cloud': {
    ...
    es: {
      ...
      highlights: [
        { icon: '✦', title: 'Interfaz intuitiva', desc: 'Una experiencia de usuario amigable que simplifica la navegación y el manejo de la información.' },
        { icon: '◇', title: 'Gestión integral', desc: 'Centraliza toda la información del personal, desde el reclutamiento hasta la desvinculación.' },
        { icon: '◈', title: 'Automatización de nómina', desc: 'Optimiza el cálculo, administración y procesamiento de la nómina, incluyendo la integración con instituciones bancarias.' },
        { icon: '◎', title: 'Evaluación del personal', desc: 'Permite realizar evaluaciones de desempeño, planificar carreras y gestionar programas de capacitación.' },
        { icon: '⟐', title: 'Gestión de beneficios', desc: 'Administra paquetes salariales, beneficios y bonificaciones de manera eficiente.' },
        { icon: '⬡', title: 'Salud ocupacional', desc: 'Maneja aspectos relacionados con la seguridad y bienestar de los empleados.' },
      ],
      sections: [
        {
          type: 'modules', title: 'Módulos',
          items: [
            { icon: '◉', label: 'Recursos Humanos' }, { icon: '◈', label: 'Nómina' }, { icon: '✦', label: 'Clima Laboral' },
          ],
        },
      ],
    },
    en: {
      ...
      highlights: [
        { icon: '✦', title: 'Intuitive interface', desc: 'A friendly user experience that simplifies navigating and managing information.' },
        { icon: '◇', title: 'End-to-end management', desc: 'Centralizes all personnel information, from recruitment through offboarding.' },
        { icon: '◈', title: 'Payroll automation', desc: 'Streamlines payroll calculation, administration, and processing, including integration with banking institutions.' },
        { icon: '◎', title: 'Performance evaluation', desc: 'Run performance reviews, plan careers, and manage training programs.' },
        { icon: '⟐', title: 'Benefits management', desc: 'Administer salary packages, benefits, and bonuses efficiently.' },
        { icon: '⬡', title: 'Occupational health', desc: 'Manage everything related to employee safety and well-being.' },
      ],
      sections: [
        {
          type: 'modules', title: 'Modules',
          items: [
            { icon: '◉', label: 'Human Resources' }, { icon: '◈', label: 'Payroll' }, { icon: '✦', label: 'Workplace Climate' },
          ],
        },
      ],
    },
  ...
  'huawei-cloud': {
    ...
    es: {
      ...
      highlights: [
        { icon: '☁', title: 'Multi-región', desc: 'Infraestructura distribuida que garantiza baja latencia y alta disponibilidad para aplicaciones críticas.' },
        { icon: '⬡', title: 'Entorno seguro', desc: 'Un entorno protegido y eficiente para tus operaciones comerciales sobre SAP Business One.' },
        { icon: '⇗', title: 'Escalabilidad', desc: 'Escala tus operaciones e integra add-ons de SAP adaptados a las necesidades del negocio.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '☁', title: 'Multi-region', desc: 'Distributed infrastructure that guarantees low latency and high availability for critical applications.' },
        { icon: '⬡', title: 'Secure environment', desc: 'A protected, efficient environment for your business operations on SAP Business One.' },
        { icon: '⇗', title: 'Scalability', desc: 'Scale your operations and integrate SAP add-ons tailored to your business needs.' },
      ],
      sections: [],
    },
  },
  ...
  'sky-one': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◇', title: 'Soluciones a medida', desc: 'Migración de aplicaciones SAP e integración de add-ons optimizando rendimiento y costos.' },
        { icon: '⬡', title: 'Enfoque en la seguridad', desc: 'Copias de seguridad automatizadas y recuperación ante desastres como capa adicional de protección.' },
        { icon: '◎', title: 'Consultoría y soporte', desc: 'Acompañamiento en la transformación digital para que te concentres en crecer.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '◇', title: 'Tailored solutions', desc: 'SAP application migration and add-on integration that optimize performance and costs.' },
        { icon: '⬡', title: 'Security first', desc: 'Automated backups and disaster recovery as an additional layer of protection.' },
        { icon: '◎', title: 'Consulting and support', desc: 'Guidance through your digital transformation so you can focus on growing.' },
      ],
      sections: [],
    },
  },
  ...
  'pos-b1': {
    ...
    es: {
      ...
      highlights: [
        { icon: '⇄', title: 'Integración con SAP', desc: 'Punto de venta integrado con SAP Business One para comercios minoristas y empresas con operaciones de venta directa.' },
        { icon: '◈', title: 'Compatibilidad', desc: 'Compatible con Microsoft SQL Server y SAP HANA, con flexibilidad y continuidad en todas tus estaciones de trabajo.' },
        { icon: '✦', title: 'Experiencia de compra', desc: 'Operaciones ágiles que mejoran la experiencia de tus clientes en el piso de venta.' },
      ],
      sections: [
        {
          ...
          items: [
            { icon: '⇗', label: 'Sales By Lynx' }, { icon: '▤', label: 'Stock By Lynx' }, { icon: '⚙', label: 'PM By Lynx' },
          ],
        },
      ],
    },
    en: {
      ...
      highlights: [
        { icon: '⇄', title: 'SAP integration', desc: 'A point of sale integrated with SAP Business One, built for retailers and companies with direct-sales operations.' },
        { icon: '◈', title: 'Compatibility', desc: 'Compatible with Microsoft SQL Server and SAP HANA, with flexibility and continuity across every workstation.' },
        { icon: '✦', title: 'Better checkout', desc: 'Fast, reliable operations that improve the customer experience on the sales floor.' },
      ],
      sections: [
        {
  ...
  'facturacion-electronica': {
    ...
    es: {
      ...
      highlights: [
        { icon: '✓', title: 'Cumple con la normativa de la DGII', desc: 'Emisión de comprobantes fiscales electrónicos conforme a la regulación dominicana.' },
        { icon: '⏱', title: 'Ahorro de tiempo y recursos', desc: 'Menos papel, menos procesos manuales, más agilidad.' },
        { icon: '⬡', title: 'Seguridad y trazabilidad', desc: 'Cada comprobante queda registrado, validado y auditable.' },
        { icon: '☁', title: 'Accesibilidad y almacenamiento', desc: 'Tus facturas disponibles de forma digital, cuando las necesites.' },
      ],
      sections: [
        {
    ...
    en: {
      ...
      highlights: [
        { icon: '✓', title: 'DGII compliant', desc: 'Electronic tax receipts issued in full compliance with Dominican regulations.' },
        { icon: '⏱', title: 'Saves time and resources', desc: 'Less paper, fewer manual processes, more agility.' },
        { icon: '⬡', title: 'Security and traceability', desc: 'Every receipt is recorded, validated, and auditable.' },
        { icon: '☁', title: 'Accessibility and storage', desc: 'Your invoices available digitally, whenever you need them.' },
      ],
      sections: [
        {
  ...
  'microsoft-365': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◇', title: 'Para MiPymes', desc: 'Microsoft 365 Business Basic, Standard y Premium: desde herramientas esenciales hasta seguridad avanzada.' },
        { icon: '⬡', title: 'Para empresas grandes', desc: 'Planes Enterprise E1, E3 y E5 con capacidades avanzadas de seguridad, cumplimiento y colaboración.' },
        { icon: '◎', title: 'Acompañamiento FMP', desc: 'Te asesoramos en la elección del plan adecuado y en todo el proceso de activación.' },
      ],
      sections: [
        {
    ...
    en: {
      ...
      highlights: [
        { icon: '◇', title: 'For SMBs', desc: 'Microsoft 365 Business Basic, Standard, and Premium: from essential tools to advanced security.' },
        { icon: '⬡', title: 'For large enterprises', desc: 'Enterprise E1, E3, and E5 plans with advanced security, compliance, and collaboration capabilities.' },
        { icon: '◎', title: 'FMP guidance', desc: 'We help you choose the right plan and walk you through the entire activation process.' },
      ],
      sections: [
        {
  ...
  'office-365': {
    ...
    es: {
      ...
      highlights: [
        { icon: '◇', title: 'Home & Student 2021', desc: 'Para estudiantes: las aplicaciones esenciales con un solo pago.' },
        { icon: '⟐', title: 'Home & Business 2021', desc: 'Para profesionales independientes: incluye Outlook para gestionar tu correo.' },
        { icon: '◆', title: 'Professional 2021', desc: 'Para pequeñas empresas: la suite completa de productividad.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '◇', title: 'Home & Student 2021', desc: 'For students: the essential apps with a single payment.' },
        { icon: '⟐', title: 'Home & Business 2021', desc: 'For independent professionals: includes Outlook for managing your email.' },
        { icon: '◆', title: 'Professional 2021', desc: 'For small businesses: the complete productivity suite.' },
      ],
      sections: [],
    },
  },
  ...
  windows: {
    ...
    es: {
      ...
      highlights: [
        { icon: '◇', title: 'Windows 10 / 11 Pro', desc: 'Estaciones de trabajo confiables y equipos de alto rendimiento para profesionales.' },
        { icon: '⬡', title: 'Windows Server', desc: 'Servidores potentes para gestionar redes empresariales completas.' },
        { icon: '◎', title: 'Instalación y soporte', desc: 'Instalación, configuración, mantenimiento y soporte técnico especializado.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '◇', title: 'Windows 10 / 11 Pro', desc: 'Reliable workstations and high-performance machines for professionals.' },
        { icon: '⬡', title: 'Windows Server', desc: 'Powerful servers to manage complete enterprise networks.' },
        { icon: '◎', title: 'Installation and support', desc: 'Installation, configuration, maintenance, and specialized technical support.' },
      ],
      sections: [],
    },
  },
  ...
  addons: {
    ...
    es: {
      ...
      highlights: [
        { icon: '⚑', title: 'Localización fiscal', desc: 'Adaptación a normativas locales para República Dominicana, México, Guatemala y Venezuela.' },
        { icon: '◈', title: 'Caja chica', desc: 'Gestión eficiente de pequeños gastos.' },
        { icon: '✈', title: 'Viáticos', desc: 'Control y administración de gastos de viaje.' },
        { icon: '⚙', title: 'Mantenimiento', desc: 'Soporte y gestión de activos.' },
        { icon: '⇄', title: 'Conciliación bancaria', desc: 'Automatización del proceso de conciliación.' },
        { icon: '▥', title: 'Requisiciones', desc: 'Optimización en la gestión de pedidos y compras.' },
      ],
      sections: [],
    },
    en: {
      ...
      highlights: [
        { icon: '⚑', title: 'Tax localization', desc: 'Adaptation to local regulations for the Dominican Republic, Mexico, Guatemala, and Venezuela.' },
        { icon: '◈', title: 'Petty cash', desc: 'Efficient management of small expenses.' },
        { icon: '✈', title: 'Travel expenses', desc: 'Control and administration of travel spending.' },
        { icon: '⚙', title: 'Maintenance', desc: 'Asset support and management.' },
        { icon: '⇄', title: 'Bank reconciliation', desc: 'Automation of the reconciliation process.' },
        { icon: '▥', title: 'Requisitions', desc: 'Streamlined order and purchasing management.' },
      ],
      sections: [],
    },
  },
